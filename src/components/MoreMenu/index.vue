<template>
  <div class="menu" ref="menu">
          ...
          <form action>
            ...
            <ul>
              ...
              <li style="border: none">
                <span>简介</span>
                <span>{{
                  userInfo.autograph || "这个人很懒，什么都没留下"
                }}</span>
              </li>
            </ul>
            <div class="save_useredit">
              <Button style="background: #5869da; color: white; margin: 0 10px"
                >保存</Button
              >
            </div>
          </form>
    ...
    <div class="w-20 h-20 fixed top-1/2 left-1/2">
...
<script>
import { Icon, Button, Modal ,Upload  } from "ant-design-vue";
