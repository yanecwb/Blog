        ...
        <ul>
          ...
          <div class=" flex justify-between items-center">
           ...
           <router-link to="/message_center/chat_room" target="_Blank" class="hvr-icon-up">
              ...
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="right-entry-icon fa fa-arrow-circle-o-up hvr-icon  w-4 h-4 md:w-10 md:h-10 ">
