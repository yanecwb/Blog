    ...
    >
      ...
      <div class="w-full flex justify-between">
        <div class="p-4 w-1/4 md:w-1/5 flex justify-between items-center text-gray ">
          ...
          <i class="cursor-pointer iconfont icon-dianzan  text-xl md:text-2xl" :class="like.like ? 'text-blue-800' : ''"></i></div>
          <div @click='unlikeIt' style="transform: rotate(180deg)" title="😭"><i class="cursor-pointer iconfont icon-dianzan text-xl md:text-2xl" :class="like.unlike ? 'text-red-600' : ''"></i></div>
