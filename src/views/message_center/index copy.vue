<template>
  <div class="w-screen overflow-hidden h-screen min-h-300 bg-cover bg-center" style="background-image: url(http://flechazoblog.site:5006/img/home_img/fa7a162e40a540f57b3c80aeb8c8fe0f.jpg); background-repeat: no-repeat;">
...
<script>
var ws = new WebSocket("http://localhost:4000/");
