<template>
  <div class="w-screen overflow-hidden h-screen min-h-300 bg-cover bg-center animate__animated animate__fadeIn" style="background-image: url(https://tva1.sinaimg.cn/large/e8a55238gy1h5ehe2hhwdj22yo1o01kx.jpg); background-repeat: no-repeat;">
