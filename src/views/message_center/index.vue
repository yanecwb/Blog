<template>
  <div class="w-screen overflow-hidden h-screen min-h-300 bg-cover bg-center animate__animated animate__fadeIn" style="background-image: url(http://flechazoblog.site:5006/img/home_img/fa7a162e40a540f57b3c80aeb8c8fe0f.jpg); background-repeat: no-repeat;">
